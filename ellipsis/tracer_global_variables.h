...
struct TRACERS {
  ...
  standard_precision *strd_hor;
  standard_precision *strd_ver;
  ...
  standard_precision Melt_extract[MAX_MATERIALS]; /*RAA: 10/07/03, O'Neill melting stuff */
  standard_precision Depl_visc_change[MAX_MATERIALS];
  standard_precision Melt_total_viscosity_change[MAX_MATERIALS];
  standard_precision MeltF_start_visc_change[MAX_MATERIALS];
  standard_precision MeltF_end_visc_change[MAX_MATERIALS];
  standard_precision sp0[MAX_MATERIALS]; 
  ...
  standard_precision Melt_on[MAX_MATERIALS];
  standard_precision dim_d0[MAX_MATERIALS];
  standard_precision dim_d1[MAX_MATERIALS];
  standard_precision dim_T0[MAX_MATERIALS];
  standard_precision dim_T1[MAX_MATERIALS];
  standard_precision dim_ag[MAX_MATERIALS];
