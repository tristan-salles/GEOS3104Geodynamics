...
{ 
  ...
  E->melt = (standard_precision *) Malloc0((E->mesh.nno+1)*sizeof(standard_precision));
  /*RAA: 24/09/02, depl is melting stuff by C. O'Neill */

  /*  E->S11 = (standard_precision *) Malloc0((E->mesh.nno+1)*sizeof(standard_precision)); */
  ...
  memset(E->melt,0,(E->mesh.nno+1)*sizeof(standard_precision));
  ...
  E->Pvisc = (standard_precision *) Malloc0((E->mesh.nno+1)*sizeof(standard_precision));
