...
{ 
 ...
 standard_precision dXdash13,dXdash31,dXdash23,dXdash32,dXdash33; /*RAA: 7/12/01*/
  ...
  if(E->control.verbose)
      fprintf(stderr,"Bus error coming soon ... Velocity processing\n");
  ...
  /* Nodal representation of strain-rate and deviatoric stress invariants (RAA...and depletion)*/
...
gs_tracers_to_nodes(E,E->melt,NULL,NULL,NULL,E->tracer.melt,E->mesh.levmax,0); 
gs_tracers_to_nodes(E,E->Pvisc,NULL,NULL,NULL,E->tracer.Visc,E->mesh.levmax,0); 
...
for(sample=0;sample<E->tracer.SAMPLE_PTS;sample++) {
  ...
  case 12:
      ...
      break;
  case 13:
      sample_variable=E->Pvisc;
      break;
  case 14:  
      sample_variable=E->depl;
      break;
  case 15:  
      sample_variable=E->melt;
      break;  
  case 16:  
      sample_variable=E->strd_hor;
      break;
  case 17:
      sample_variable=E->strd_ver;
      break;
  }
    /* Old case 12. Who needs grain size anyway....
