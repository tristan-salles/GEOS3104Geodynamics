...
struct VISC_OPT {
  ...
  standard_precision Depl_visc_change;
  standard_precision Melt_total_viscosity_change;
  standard_precision MeltF_start_visc_change;
  standard_precision MeltF_end_visc_change;
  standard_precision Melt_on;
  standard_precision dim_d0,dim_d1,dim_T0,dim_T1,dim_ag;
